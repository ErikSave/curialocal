<div class="modal fade" id="crearUsaurioModal" tabindex="-1" aria-hidden="true">
	<!--begin::Modal dialog-->
				...
				<form id="kt_modal_new_target_form" class="form" action="#">
					...
					<div class="d-flex flex-column mb-4 fv-row">
						...
						<label class="d-flex align-items-center fs-6 fw-bold mb-2">
							...
							<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
								title="Coloca los apellidos Paterno o Materno"></i>
						</label>
						<!--end::Label-->
						<input type="text" class="form-control form-control-solid" placeholder="PATERNO MATERNO"
							name="apellido" />
					</div>
					<div class="row g-9 mb-8">
						...
						<div class="d-flex flex-column mb-4 fv-row">
							...
							<label class="d-flex align-items-center fs-6 fw-bold mb-2">
								...
								<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
								title="Correo @gmail.com outlook.com e.t.c."></i>
							</label>
							<!--end::Label-->
							<input type="email" class="form-control form-control-solid" placeholder="Ej. correo@gmail.com"
							name="apellido" />
						</div>
					</div>
					<!--end::Input group-->
