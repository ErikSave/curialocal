...
// Verificar si el usuario no ha iniciado sesión, redirigirlo al formulario de inicio de sesión
                    ...
                    <div class="card-body container-xxl pt-10 pb-8">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-lg-flex align-lg-items-center">
                                    ...
                                    <div class="row flex-grow-1 mb-5 mb-lg-0">
                                        ...
                                        <div class="col-lg-4 d-flex align-items-center mb-3 mb-lg-0">
                                            ...
                                            <input type="text" class="form-control form-control-flush flex-grow-1"
                                                name="search" value="" placeholder="Your Search" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                ...
                                <!--begin::Action-->
                                <div class="d-flex align-items-center">
                                    <a class="fw-bold link-white fs-5" href="pages/search/horizontal.html">Advanced
                                        Search</a>
                                </div>
                                <!--end::Action-->
                            </div>
                                    ...
                                    <div class="card-header align-items-center border-0 mt-4">
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                                data-kt-menu="true" id="kt_menu_614852366e481">
                                                <!--begin::Header-->
                                                <div class="px-7 py-5">
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl-0">
                                    ...
                                    <div class="card-body d-flex flex-column pb-10 pb-lg-15">
                                        <div class="flex-grow-1">
                                            ...
                                            <!--begin::Desc-->
                                            <p class="py-3">
                                                Pitstop creates quick email campaigns. <br />We help
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl-0">
                                    ...
                                    <div class="card-body d-flex flex-column pb-10 pb-lg-15">
                                        <div class="flex-grow-1">
                                            ...
                                            <!--end::Info-->
                                            <!--begin::Link-->
                                            <a href="#" class="text-dark fw-bolder text-hover-primary fs-4">ReactJS
                                                Admin Theme</a>
                                            <!--end::Link-->
                                            <!--begin::Desc-->
                                            <p class="py-3">
                                                Keenthemes uses the latest and greatest
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl-0">
                                    ...
                                    <div class="card-body d-flex flex-column pb-10 pb-lg-15">
                                        <div class="flex-grow-1">
                                            ...
                                            <!--end::Info-->
                                            <!--begin::Link-->
                                            <a href="#" class="text-dark fw-bolder text-hover-primary fs-4">KT.com -
                                                High Quality Templates</a>
                                            <!--end::Link-->
                                            <!--begin::Desc-->
                                            <p class="py-3">
                                                Easy to use, incredibly flexible and secure <br />with
                                                in-depth documentation that outlines.
                                            </p>
                                            <!--end::Desc-->
                                        </div>
                                        <!--begin::Team-->
